...
const T = {
  ru: {
    ...
    walk_s6:      "Выберите язык интерфейса и язык перевода в настройках расширения — метки, подсказки и переводы подстроятся под выбор.",
    walk_s7:      "Вставьте свой API-ключ от OpenAI, Anthropic, Google или xAI — ключ хранится только в вашем браузере и никуда не передаётся, кроме выбранного провайдера.",
  ...
  en: {
    ...
    walk_s6:      "Pick your interface language and translation language in the extension settings — labels, hints and translations adjust instantly.",
    walk_s7:      "Paste your API key from OpenAI, Anthropic, Google or xAI — the key stays in your browser and is sent only to the provider you chose.",
  ...
  es: {
    ...
    walk_s6:      "Elige el idioma de la interfaz y el idioma de traducción en los ajustes de la extensión — etiquetas, sugerencias y traducciones se ajustan al instante.",
    walk_s7:      "Pega tu clave API de OpenAI, Anthropic, Google o xAI — la clave se guarda solo en tu navegador y se envía únicamente al proveedor elegido.",
  ...
  zh: {
    ...
    walk_s6:      "在扩展设置中选择界面语言和翻译语言——标签、提示和翻译会立即调整。",
    walk_s7:      "粘贴您来自 OpenAI、Anthropic、Google 或 xAI 的 API 密钥——密钥仅保存在您的浏览器中，只会发送给您所选的提供商。",
