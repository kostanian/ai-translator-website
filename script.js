...
const T = {
  ru: {
    ...
    walk_s6:      "Откройте расширение и выберите: язык интерфейса (на котором будут подписи и объяснения) и язык, на который хотите переводить выделенный текст.",
  ...
  en: {
    ...
    walk_s6:      "Open the extension and choose: the interface language (labels and explanations) and the language to translate the selected text into.",
  ...
  es: {
    ...
    walk_s6:      "Abre la extensión y elige: el idioma de la interfaz (etiquetas y explicaciones) y el idioma al que quieres traducir el texto seleccionado.",
  ...
  zh: {
    ...
    walk_s6:      "打开扩展并选择：界面语言（用于标签和解释）以及要将所选文本翻译成的语言。",
